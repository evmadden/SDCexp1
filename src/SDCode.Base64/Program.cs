...
namespace SDCode.Base64
{
    class Program
    {
        ...
        //static readonly string MimeType = "image/jpeg";
        ...
        //static readonly string MimeType = "image/png";

        //public static readonly string ImagesPath = System.IO.Path.Join("..","assets","img","Stimuli", "Congruency_Fixed");
        //static readonly string FileExtension = "jpg";
        //static readonly string MimeType = "image/jpeg";

        public static readonly string ImagesPath = System.IO.Path.Join("..","assets","img","Audio Files"); // src/assets/img/Audio Files
        static readonly string FileExtension = "mp3";
        static readonly string MimeType = "audio/mpeg";
        
        static void Main(string[] args)
        {
            var stimuliDataUrlGetter = new StimuliDataUrlGetter(FileExtension, MimeType);
            ...
            {
                var data = typeIndexes.ToDictionary(x=>x, stimuliDataUrlGetter.Get);
